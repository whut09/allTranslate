"""Fast kernel adapter — wraps existing allTranslate.high_level.translate()."""
...
from allTranslate.kernel.protocol import TranslateRequest, TranslateResult

logger = logging.getLogger(__name__)


class LegacyKernel:
    """Kernel adapter for the original allTranslate translation pipeline (fast mode)."""
    ...
    def translate(
        ...
        from allTranslate.doclayout import ModelInstance, OnnxModel
        ...
        if request.skip_classes is not None:
            kwargs["skip_classes"] = request.skip_classes
