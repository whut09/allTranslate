...
class TestKernelProtocol(unittest.TestCase):
    ...
    def test_translate_result_defaults(self):
        from allTranslate.kernel.protocol import TranslateResult
...
class TestV2Bridge(unittest.TestCase):
    ...
    def test_cli_args_basic(self):
        from allTranslate.kernel.v2_bridge import request_to_cli_args
        from allTranslate.kernel.protocol import TranslateRequest
    ...
    def test_service_name_mapping(self):
        from allTranslate.kernel.v2_bridge import SERVICE_NAME_MAP
    ...
    def test_request_to_env_maps_envs(self):
        from allTranslate.kernel.v2_bridge import request_to_env
        from allTranslate.kernel.protocol import TranslateRequest
        ...
        self.assertEqual(env["ALLTRANSLATE_OPENAI_API_KEY"], "sk-test123")
        self.assertEqual(env["ALLTRANSLATE_OPENAI_BASE_URL"], "https://custom.api")
    ...
    def test_request_to_env_service_model(self):
        ...
        env = request_to_env(req)
        self.assertEqual(env["ALLTRANSLATE_DEEPSEEK_API_KEY"], "ds-key")
        self.assertEqual(env["ALLTRANSLATE_DEEPSEEK_MODEL"], "deepseek-reasoner")
...
class TestLegacyKernelTranslation(unittest.TestCase):
    ...
    @patch("allTranslate.high_level.translate")
    @patch("allTranslate.doclayout.OnnxModel")
    @patch("allTranslate.doclayout.ModelInstance")
...
class TestPreciseKernelTranslation(unittest.TestCase):
    ...
    @patch("allTranslate.kernel.precise.subprocess.Popen")
    @patch(
        "allTranslate.kernel.precise.PreciseKernel.is_available",
        return_value=True,
    )
    @patch("allTranslate.kernel.precise.PreciseKernel.ensure_venv")
...
class TestV2BridgeEndToEnd(unittest.TestCase):
    ...
    def test_all_services_produce_cli_flag(self):
        from allTranslate.kernel.v2_bridge import SERVICE_NAME_MAP, request_to_cli_args
        from allTranslate.kernel.protocol import TranslateRequest
    ...
    def test_env_all_fields(self):
        ...
        self.assertEqual(env["ALLTRANSLATE_GEMINI_API_KEY"], "key123")
        self.assertEqual(env["ALLTRANSLATE_GEMINI_MODEL"], "gemini-pro")
...
class TestCLIKernelPipeline(unittest.TestCase):
    ...
    @patch("allTranslate.kernel.registry.KernelRegistry.switch")
    @patch("allTranslate.kernel.registry.KernelRegistry.get")
    @patch("allTranslate.doclayout.set_backend")
    @patch("allTranslate.doclayout.OnnxModel")
    @patch("allTranslate.doclayout.ModelInstance")
    def test_cli_fast_mode_routes_through_kernel(
        ...
        from allTranslate.allTranslate import main
